...
Chúng tôi duy trì và cập nhật bảo mật cho các phiên bản chính thức của repo **thu thập dữ liệu** trong dự án GreenMap.  
...
Chúng tôi đánh giá cao sự hợp tác của cộng đồng trong việc giúp dự án **GreenMap** an toàn và minh bạch hơn.  